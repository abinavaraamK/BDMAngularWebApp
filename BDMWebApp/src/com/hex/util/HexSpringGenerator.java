 ...
 * @version 1.0
 */
public class HexSpringGenerator {

    protected String lsPackage = "";
    protected String lsPackageDir = "";

    public HexSpringGenerator() {
    }
    
    public void generateSpringFiles(ArrayList list) {

        System.out.println("**********Enter into generateSpringFiles method*********");
    ...
    private String getServiceImplContent(String className, String valueObject,
        ...
        try {
            ...
            InputStream inputStream= UIController.class.getResourceAsStream("\\templates\\templates\\service\\ServiceImpl.template");
			 DataInputStream dis = new DataInputStream(inputStream);
            while (dis.available() > 0) {
                String line = dis.readLine();
    ...
    private String getInterfaceContent(String className, String valueObject,
        ...
        try {
            ...
            InputStream inputStream= UIController.class.getResourceAsStream("\\templates\\templates\\service\\ServiceInterface.template");
			 DataInputStream dis = new DataInputStream(inputStream);
            while (dis.available() > 0) {
                String line = dis.readLine();
                line = HexUtil.replaceTags(line, "<ClassName>", className);
